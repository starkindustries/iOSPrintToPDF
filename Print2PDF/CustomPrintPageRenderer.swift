...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    override init() {
        ...
        // old: self.setValue(NSValue(cgRect: pageFrame), forKey: "paperRect")
        
        // Set the horizontal and vertical insets (that's optional).
        let insetRect: CGRect = pageFrame.insetBy(dx: 10.0, dy: 10.0)
        self.setValue(insetRect, forKey: "printableRect")
        // old: self.setValue(NSValue(CGRect: CGRectInset(pageFrame, 10.0, 10.0)), forKey: "printableRect")
