...
class AddItemViewController: UIViewController, UITextFieldDelegate {
    ...
    */
    ...
    func presentAddItemViewControllerInViewController(_ originatingViewController: UIViewController, saveItemCompletionHandler: @escaping (_ itemDescription: String, _ price: String) -> Void) {
